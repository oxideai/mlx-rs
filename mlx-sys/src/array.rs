...
unsafe impl cxx::private::SharedPtrTarget for ArrayDesc {
    fn __typename(f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.write_str("ArrayDesc")
    }
...
pub struct array {
    array_desc_: cxx::SharedPtr<ArrayDesc>,
}

unsafe impl ExternType for array {
    type Id = cxx::type_id!("mlx::core::array");
...
pub mod ffi {
    unsafe extern "C++" {
        ...
        #[namespace = "mlx_cxx"]
        fn array_new_bool(value: bool) -> array;
        ...
        // #[namespace = "mlx_cxx"]
        // fn shared_array_from_bool(value: bool) -> SharedPtr<array>;
    }
}
